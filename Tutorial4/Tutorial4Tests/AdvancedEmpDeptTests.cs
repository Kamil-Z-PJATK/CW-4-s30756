...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(emps=>emps.DeptNo==30).Select(emps=>emps.Sal).Min();
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(emps=>emps.Mgr is not null).ToList(); 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        Assert.True(result.All(emp => emp.Sal>500));
    }
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        Assert.True(result.Any(emp => emp.Comm>400));
    }
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, emp =>emp.DeptNo, dept =>dept.DeptNo, (emp, dept) => new {emp,dept}).
                                        Join(grades, ed=>ed.emp.Sal, salgrade => salgrade.Losal, (ed, salgrade) =>new {ed, salgrade}).
                                        Where(eds =>eds.ed.emp.Sal<eds.salgrade.Hisal && eds.ed.emp.Sal>eds.salgrade.Losal ).
                                        Select(eds=> new{eds.ed.emp.EName,eds.ed.dept.DName,eds.salgrade.Grade});
                                        ; 
